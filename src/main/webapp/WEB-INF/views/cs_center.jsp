...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="resources/css/cs_center.css">
...
<body>
    <div class="container">
        ...
        <div class="main">
            <div class="inquiry">
                <div class="m-top">
                    <h2><b>Udon에 문의하기🙋‍♂️</b></h2>
                </div>
                <div class="m-middle">
                    <div class="name">
                        <h3>이름:</h3>
                        <input type="text" name="inquiry" placeholder="이름을 입력해주세요.">
                    </div>
                    <div class="email">
                        <h3>이메일:</h3>
                        <input type="text" name="inquiry" placeholder="이메일 주소를 입력해주세요.">
                    </div>
                </div>
                <div class="m-bottom">
                    <h3>문의내용:</h3>
                    <input type="text" name="inquiry" placeholder="문의하실 내용을 작성해주세요.">
                    <button class="btn btn-md btn-warning">전달하기</button>
                </div>
            </div>
        </div>
        <div class="footer">
